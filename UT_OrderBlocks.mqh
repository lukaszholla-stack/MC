...
COrderBlockDetector::COrderBlockDetector() {
    ...
    m_maxOrderBlocks = 10;
    m_lookbackBars = 50;
    m_minImpulseATR = 0.35;       // 35% of ATR (crypto M15 needs lower threshold)
...
bool COrderBlockDetector::IsImpulsiveCandle(int bar, double atr, ENUM_OB_TYPE &impulseType) {
    ...
    // Impulse criteria:
    // 1. Range > m_minImpulseATR * ATR (35% - optimized for crypto M15)
    // 2. Body > 50% of range (balanced body/wick ratio)
